...
team_1516 = np.genfromtxt('1516team.csv', delimiter=',',
                   encoding='utf-8', dtype=None)
player_1516 = np.genfromtxt('1516player.csv', delimiter=',', encoding='utf-8', dtype=None)
team_1617 = np.genfromtxt('1617team.csv', delimiter=',',
                   encoding='utf-8', dtype=None)
player_1617 = np.genfromtxt('1617player.csv', delimiter=',', encoding='utf-8', dtype=None)
team_1718 = np.genfromtxt('1718team.csv', delimiter=',',
                   encoding='utf-8', dtype=None)
player_1718 = np.genfromtxt('1718player.csv', delimiter=',', encoding='utf-8', dtype=None)
